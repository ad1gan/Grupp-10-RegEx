public class Automat{
	...
	private Pair parseChar(char a){
		...
		start = end = counter;
		counter++;
		Pair neu = new Pair(start, end);
		return neu;
	}
	private void parseAnd (Syntaxbaum left, Syntaxbaum right, int start, int end){
		
	}
	private void parseOr  (Syntaxbaum left, Syntaxbaum right, int start, int end){
